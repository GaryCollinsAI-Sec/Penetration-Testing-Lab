...
|----------------------|----------------------|----------------------------------------------------------|------|
| Backdoor Attack Lab  | FTP exploitation     | Nmap, Exploitation, NCAT, ARP scan, Remediation    | [View Lab](https://github.com/GaryCollinsAI-Sec/Backdoor-Attack-Lab-Legacy-System-Exploitation-Remediation) |
